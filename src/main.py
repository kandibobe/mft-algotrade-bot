...
class TradingBot:
    ...
    def close_all_positions(self, reason: str = "shutdown") -> None:
        ...
        log.info(
            "closing_positions", count=len(self.positions), reason=reason
        )
    ...
    def save_state(self, filepath: str) -> None:
        ...
        log.info(
            "state_saved", filepath=filepath, position_count=len(self.positions)
        )
...
class GracefulShutdown:
    ...
    def handle_shutdown(self, signum, frame):
        ...
        log.warning(
            "shutdown_initiated", signal=signal_name, signum=signum
        )
...
def main():
    ...
    _shutdown_handler = GracefulShutdown(bot)
