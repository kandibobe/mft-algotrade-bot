...
from .data_stream import TickerData, TradeData, WebSocketDataStream, StreamConfig, Exchange
...
class DataAggregator:
    ...
    def __init__(self, aggregation_interval: float = 0.1):
        ...
        # Data storage
        self._tickers: Dict[str, Dict[str, TickerData]] = defaultdict(dict)  # symbol -> exchange -> ticker
    ...
    def _aggregate_ticker(self, symbol: str, exchange_tickers: Dict[str, TickerData]) -> AggregatedTicker:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        stream_stats = {
            exchange.value: stream.get_stats()
