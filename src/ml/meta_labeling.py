...
class MetaLabeler:
    ...
    @staticmethod
    def filter_signals(signals: pd.Series, meta_predictions: pd.Series, threshold: float = 0.5) -> pd.Series:
        """
        ...
        logger.info(f"Meta-labeling filtered out {dropped_count} signals "
