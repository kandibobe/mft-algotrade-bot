...
SUPPORTED_MACRO_FOR_REPORT = {"CPI": FRED_CPI, "M2": FRED_M2, "DXY": FRED_DXY, "FFR": FRED_FEDFUNDS, "UNRATE": FRED_UNRATE}

SUPPORTED_ASSETS = {
    "BTC": (ASSET_CRYPTO, CG_BTC), "ETH": (ASSET_CRYPTO, CG_ETH), "SOL": (ASSET_CRYPTO, CG_SOL),
    "DOGE": (ASSET_CRYPTO, CG_DOGE), "ADA": (ASSET_CRYPTO, CG_ADA), "XRP": (ASSET_CRYPTO, CG_XRP),
    "DOT": (ASSET_CRYPTO, CG_DOT), "LINK": (ASSET_CRYPTO, CG_LINK), "LTC": (ASSET_CRYPTO, CG_LTC),
    "BNB": (ASSET_CRYPTO, CG_BNB),
    "EURUSD": (ASSET_FOREX, "EURUSD"), "GBPUSD": (ASSET_FOREX, "GBPUSD"), "USDJPY": (ASSET_FOREX, "USDJPY"),
    INDEX_SPY: (ASSET_INDEX, INDEX_SPY), INDEX_QQQ: (ASSET_INDEX, INDEX_QQQ),
}
...
MSG_ANALYTICS_CHAT_COMMAND_NOT_SUPPORTED_FOR_ASSET = "analytics_chat_command_not_supported_for_asset"
