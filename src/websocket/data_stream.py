...
from typing import Any, Callable, Dict, List, Optional, Set, Protocol, runtime_checkable
import websockets
from websockets.exceptions import ConnectionClosed

from .exchange_handlers import create_exchange_handler, ExchangeHandler
...
class WebSocketDataStream:
    ...
    async def _subscribe(self):
        ...
        await self._exchange_handler.subscribe(
            self._ws, 
            self.config.symbols, 
